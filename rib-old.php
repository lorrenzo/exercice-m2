...
// Selectionner les données de la base de données. Voir si on ne peut pas appeler directement config.php
...
// Créer un nouveau document PDF = new FPDF(orientation P=portrait, unite de mesure millimetre=mm, format page=A4)
...
//par defaut le logo est affiché dans le coin haut gauche.
...
$pdf->SetTextColor(47,85,151);//même bleu que les en-tete de page
        
//definition du RIB comme un tableau sans bordures Cell(largeur jusqu'a la marge a droite, hauteur, texte a ecrire, bordure 0=sans bordure, position à la fin 0=droite 1=deb ligne suivante 2=en dessous, alignement L a gauche C=centre R=droite, remplissage 0=non 1=oui) )        
...
$pdf->Cell(80,7,'Clé RIB',0,1,'C',0);// titre quatrieme colonne

//remplissage des donnees avec les info de la requête SQL
...
// télécharge le fichier Output(nom du fichier, type de destination F=serveur I=navigateur en ligne D=telechargement)
