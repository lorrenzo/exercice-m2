...
<br/>
						...
						$sql= 	"
                            ...
                            <br/>
                            <div class="form-group">
                                <label class="control-label col-sm-4">S&eacute;lection du compte personnel &agrave; cr&eacute;diter&nbsp;
                                </label> 
                                <div class="col-sm-3">
                                        <?php
                                                ...
                                                {					
                                                        for ( $i = 1; $i <= $count; $i++ ) 
                                                        {
                                                                ...
                                                                {						
                                                                    ...
                                                                    //mettre une option value
                                                                        echo "<option value='$id_compte2'>".$type_compte2."&nbsp;-&nbsp;N&deg;&nbsp;".$id_compte2 ."&nbsp;-&nbsp;Avoir disponible&nbsp;".$solde2." &euro;"	. "</option>";
